...
const currencies = [
  ...
  { code: 'USD', symbol: '$', balance: 12847.32, change: -1.12, flag: '🇺🇸' },
  { code: 'EUR', symbol: '€', balance: 8923.41, change: +0.89, flag: '🇪🇺' },
  { code: 'GBP', symbol: '£', balance: 6432.18, change: -0.45, flag: '🇬🇧' },
];
...
export const WalletOverview: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h2 className="text-3xl font-bold text-light-text dark:text-dark-text font-editorial">My Portfolio</h2>
          <p className="text-light-text-secondary dark:text-dark-text-secondary mt-1">Personal currency holdings & investments</p>
        </div>
        <motion.button
      ...
      >
        ...
        <div className="relative">
          <p className="text-light-text-secondary dark:text-dark-text-secondary text-sm uppercase tracking-wider">Total Net Worth</p>
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
          ...
          <div className="flex items-center space-x-2 mt-3">
            ...
            <span className="text-lime-accent text-sm">+₹8,432 this month</span>
          </div>
        </div>
      </motion.div>
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Available</p>
                </div>
              </div>
