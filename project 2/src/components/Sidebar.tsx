    ...
    >
      ...
      <div className="p-6 border-b border-light-border dark:border-dark-border flex items-center justify-between">
        ...
        >
          {!isCollapsed && (
            <div>
              <h1 className="text-lg font-bold text-lime-accent font-editorial">FinanceClub</h1>
              <p className="text-xs text-light-text-secondary dark:text-dark-text-secondary">Sairaj Banking</p>
            </div>
          )}
        </motion.div>
        <button
      ...
      <div className="p-4 border-t border-light-border dark:border-dark-border">
        <div className="flex items-center space-x-3 p-3 bg-light-glass dark:bg-dark-glass rounded-xl">
          <div className="w-8 h-8 bg-lime-accent rounded-full flex items-center justify-center">
            <span className="text-light-base dark:text-dark-base font-bold text-sm">SC</span>
          </div>
          {!isCollapsed && (
            <motion.div
              initial={{ opacity: 1 }}
              ...
              transition={{ duration: 0.2 }}
            >
              <p className="text-sm font-medium text-light-text dark:text-dark-text">Sairaj Chowdhary</p>
